...
wrapper '>
    <header>
      ...
      <a href="index.php" class="logo"><img src="images/logo.png" alt="your logo" /></a>
			<nav class="main-menu">
				<ul>
					<li class="current"><a href="listing.php">Fruits and vegetables</a></li>
				...
				<div class="meals-listing">
					<ul>
						<li class="meal-details">
							<div class="image"><img src="images/meal-9.jpg" alt=""></div>
							<div class="info">
								<div class="descr-holder">
									<h3><a href="single.php">Fried potatoes</a></h3>
						...
						<li class="meal-details">
							<div class="image"><img src="images/meal-10.jpg" alt=""></div>
							<div class="info">
								<div class="descr-holder">
									<h3><a href="single.php">Fried potatoes</a></h3>
									<div class="date_categories">Date added: 04 May | Categories: <a href="#">Entrees</a>, <a href="#">Seafood</a></div>
						...
						<li class="meal-details">
							<div class="image"><img src="images/meal-11.jpg" alt=""></div>
							<div class="info">
								<div class="descr-holder">
									<h3><a href="single.php">Fried potatoes</a></h3>
									<div class="date_categories">Date added: 04 May | Categories: <a href="#">Entrees</a>, <a href="#">Seafood</a></div>
						...
						<li class="meal-details">
							<div class="image"><img src="images/meal-12.jpg" alt=""></div>
							<div class="info">
								<div class="descr-holder">
									<h3><a href="single.php">Fried potatoes</a></h3>
									<div class="date_categories">Date added: 04 May | Categories: <a href="#">Entrees</a>, <a href="#">Seafood</a></div>
						...
						<li class="meal-details">
							<div class="image"><img src="images/meal-13.jpg" alt=""></div>
							<div class="info">
								<div class="descr-holder">
									<h3><a href="single.php">Fried potatoes</a></h3>
									<div class="date_categories">Date added: 04 May | Categories: <a href="#">Entrees</a>, <a href="#">Seafood</a></div>
