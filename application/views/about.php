    ...
    <header>
      ...
      <a href="index.php" class="logo"><img src="images/logo.png" alt="your logo" /></a>
		...
		<div class="content full-content clearfix">
			...
			<p><img src="images/content-image.jpg" alt="" style="float: left" class="img-canvas mar-r-10">Vestibulum ut leo erat. Integer ac est at enim suscipit vulputate. Phasellus ante erat, euismod et posuere ut, convallis sit amet tellus. Nulla in elit non erat tempus luctus at a est. Nullam non orci tortor. Donec congue eleifend tempus. Morbi malesuada consectetur sem ac pharetra. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer dapibus est turpis. Quisque non ligula at urna dignissim congue quis eget turpis. Cras condimentum risus in magna posuere adipiscing. Suspendisse a tempus urna. Mauris a libero metus, vel blandit lectus.</p>

			<p>Nunc laoreet urna at lacus consequat id fermentum libero adipiscing. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Phasellus fringilla vulputate mi, ut congue eros eleifend at. Mauris eu massa vel diam ultricies blandit. Nunc vestibulum placerat pulvinar. Integer dapibus est turpis. Quisque non ligula at urna dignissim congue quis eget turpis. Cras condimentum risus in magna posuere adipiscing. Suspendisse a tempus urna. Mauris a libero metus, vel blandit lectus. Integer dapibus est turpis.</p>

			<p><img src="images/content-image.jpg" alt="" style="float: right" class="img-canvas  mar-l-10">Vestibulum ut leo erat. Integer ac est at enim suscipit vulputate. Phasellus ante erat, euismod et posuere ut, convallis sit amet tellus. Nulla in elit non erat tempus luctus at a est. Nullam non orci tortor. Donec congue eleifend tempus. Morbi malesuada consectetur sem ac pharetra. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer dapibus est turpis. Quisque non ligula at urna dignissim congue quis eget turpis. Cras condimentum risus in magna posuere adipiscing. Suspendisse a tempus urna. Mauris a libero metus, vel blandit lectus.</p>
			...
			<blockquote>
				...
				Nunc laoreet urna at lacus consequat id fermentum libero adipiscing. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Phasellus fringilla vulputate mi, ut congue eros eleifend at. Mauris eu massa vel diam ultricies blandit. Nunc vestibulum placerat pulvinar.
			...
			<h1>Default Ordered and Unordered lists</h1>
			
			<div class="column-holder mar-t-20">
				<div class="col-50">
						<h2>Ordered List Style</h2>
			
						<ol>
							<li>Metusvel blandit lectus </li>
							<li>condimentum risus in magna posuere</li>
							<li>Sed lacus lectus, egestas et facilisis sed,</li>
							<li>Cimentum risus in magna posuere</li>
						</ol>
				</div>
				<div class="col-50">
			...
			<div class="column-holder mar-t-20">
				...
				<div class="col-50">
						...
						<h2>Default Order List</h2>
			
						<ol>
							<li>Metusvel blandit lectus </li>
							<li>condimentum risus in magna posuere</li>
							<li>Sed lacus lectus, egestas et facilisis sed,
								<ol>
									<li>Metusvel blandit lectus</li>
									<li>condimentum risus in magna posuere</li>
									<li>Sed lacus lectus, egestas et facilisis sed,</li>
